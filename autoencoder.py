...
def autoencoder_accompany(left, epochs=5):
	train_X, train_means, train_stds, train_length = preprocess(left[0:35])
	test_X, test_means, test_stds, test_length = preprocess(left[35:40])
